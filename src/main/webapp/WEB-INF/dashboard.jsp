...
<head>
  ...
  <style>
    ...
    .delete-button:hover {
      background-color: #911818; /* Darker shade when hovered */
    }
    /* Add some hover effect */
    .edit-button:hover {
      background-color: #1E3A72; /* Darker shade when hovered */
    .butonat {
      display: inline-block;
      vertical-align: middle;
    }

    /* Add margin between the buttons (optional) */
...
<main id="main">
  ...
  <section id="menu" class="menu">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-header">
        ...
        <h2><a href="/add-menu">Shto nje pjate</a></h2>
      </div>
      ...
      <ul class="nav nav-tabs d-flex justify-content-center" data-aos="fade-up" data-aos-delay="200">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/filter?type=sushi#menu"><h4>Sushi</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/filter?type=peshk#menu"><h4>Peshk</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/filter?type=pica#menu"><h4>Pica</h4></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="/filter?type=frutaDeti#menu"><h4>Fruta Deti</h4></a>
        </li>
      </ul>
          ...
          <div class="row gy-5">
            <c:forEach var="menu" items="${filteredMenus}">
              <div class="col-lg-4 menu-item" style="display: inline-block;">
                ...
                <div class="butonat">
                  <a href="/menu/edit/${menu.id}#menu" class="edit-button"> Edit</a>
                  <a href="/menu/delete/${menu.id}#menu" class="delete-button">Delete</a>
                </div>
    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row g-0">
        ...
        <div class="col-lg-8 d-flex align-items-center reservation-form-bg">
          <form action="${pageContext.request.contextPath}forms/book-a-table.php" method="post" role="form" class="php-email-form" data-aos="fade-up" data-aos-delay="100">
            <div class="row gy-4">
              <div class="col-lg-4 col-md-6">
                <input type="text" name="name" class="form-control" id="name" placeholder="Emri Juaj" data-rule="minlen:4" data-msg="Ju lutem vendosni te pakten 4 karaktere.">
                <div class="validate"></div>
              </div>
              <div class="col-lg-4 col-md-6">
                <input type="email" class="form-control" name="email" id="email" placeholder="Email-i Juaj" data-rule="email" data-msg="Ju lutem vendosni nje email te sakte">
                <div class="validate"></div>
              </div>
              <div class="col-lg-4 col-md-6">
                <input type="text" class="form-control" name="phone" id="phone" placeholder="Numri Juaj" data-rule="minlen:4" data-msg="Ju lutem vendosni te pakten 4 karaktere.">
                <div class="validate"></div>
              </div>
              <div class="col-lg-4 col-md-6">
                <input type="text" name="date" class="form-control" id="date" placeholder="Data" data-rule="minlen:4" data-msg="Ju lutem vendosni te pakten 4 karaktere.">
                <div class="validate"></div>
              </div>
              <div class="col-lg-4 col-md-6">
                <input type="text" class="form-control" name="time" id="time" placeholder="Koha" data-rule="minlen:4" data-msg="Ju lutem vendosni te pakten 4 karaktere.">
                <div class="validate"></div>
              </div>
              <div class="col-lg-4 col-md-6">
                <input type="number" class="form-control" name="people" id="people" placeholder="Numri i njerezve" data-rule="minlen:1" data-msg="Please enter at least 1 chars">
                <div class="validate"></div>
              </div>
            </div>
            <div class="form-group mt-3">
              <textarea class="form-control" name="message" rows="5" placeholder="Mesazh"></textarea>
              <div class="validate"></div>
            </div>
            <div class="mb-3">
              <div class="loading">Loading</div>
              <div class="error-message"></div>
              <div class="sent-message">Kerkesa juaj u dergua. Ne do ju telefonojme ose dergojme nje email per te konfirmuar rezzervimin tuaj. Falemniderit!
              </div>
            </div>
            <div class="text-center"><button type="submit">Rezervo nje Tavoline</button></div>
          </form>
  ...
  <section id="contact" class="contact">
    <div class="container" data-aos="fade-up">
      ...
      <div class="mb-3">
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d12097.269160307886!2d20.699016!3d40.7110312!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x13509f020ef9e1e5%3A0x2a016f8b5d3140c5!2sRozafa%20Fish%20City!5e0!3m2!1sen!2s!4v1699308881981!5m2!1sen!2s" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>" frameborder="0" allowfullscreen></iframe>
      </div><!-- End Google Maps -->
      ...
      <form action="/contact" method="post" role="form" class="php-email-form p-3 p-md-4">
        ...
        <div class="my-3">
          <div class="loading">Loading</div>
          <div class="error-message"></div>
          <div class="sent-message">Mesazhi juaj u dergua!</div>
        </div>
